...
try:
    idp_sp_config = settings.SAML_IDP_SPCONFIG    # pylint: disable=invalid-name
...
class IdPHandlerViewMixin:
    ...
    error_view = import_string(
        getattr(settings, 'SAML_IDP_ERROR_VIEW_CLASS', 'djangosaml2idp.error_views.SamlIDPErrorView'))
