...
setup(name='djangosaml2idp',
      ...
      install_requires=['django>=2.0', 'pysaml2>=4.5.0'],
      ...
      classifiers=[
          "Development Status :: 5 - Production/Stable", 'Environment :: Web Environment', "Framework :: Django",
          "Framework :: Django :: 2.0", "Framework :: Django :: 2.1", "Framework :: Django :: 2.2",
          ...
          "Topic :: Internet :: WWW/HTTP :: WSGI", "Topic :: Security",
